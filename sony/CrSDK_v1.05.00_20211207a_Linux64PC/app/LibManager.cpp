...
namespace cli
{
    CRLibInterface *load_cr_lib()
    {
        ...
        if (!cr_lib->Init || !cr_lib->Release || !cr_lib->EnumCameraObjects || !cr_lib->CreateCameraObjectInfo || !cr_lib->Connect || !cr_lib->Disconnect || !cr_lib->FinalizeDevice || !cr_lib->GetDeviceProperties || !cr_lib->ReleaseDeviceProperties || !cr_lib->SetDeviceProperty || !cr_lib->SendCommand || !cr_lib->SetSaveInfo)
        {
